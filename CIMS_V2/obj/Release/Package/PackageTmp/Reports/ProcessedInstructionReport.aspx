<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcessedInstructionReport.aspx.cs" MasterPageFile="~/Site.Master" Inherits="CIMS_V2.Reports.ProcessedInstructionReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table style="width: 100%">
        <tr>
            <td class="h1FB">Processed Instructions</td>
        </tr>
        <tr>
            <td class="h1FB">
                <table class="style15">
                    <tr>
                        ...
                        <td class="style18">
                            <asp:DropDownList ID="drpUserTypes" runat="server" Width="150px">
                                <asp:ListItem Value="branch_proccessed_by">Branch</asp:ListItem>
                                <asp:ListItem Value="processor_proccessed_by">Processor</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td>&nbsp;</td>
